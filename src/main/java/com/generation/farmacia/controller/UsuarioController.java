...
public class UsuarioController {
	...
	public ResponseEntity<Usuario> getByEmail(@PathVariable String usuario) {
		return usuarioRepository.findByUsuario(usuario).map(resposta -> ResponseEntity.ok(resposta))
